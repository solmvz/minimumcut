...
#--------------------------------------------CONFRONT FOR KARGER AND STOER--------------------------------------------
plt.figure()
plt.plot(sizes_nodes, times_karger, label='Karger')
plt.plot(sizes_nodes, times_stoer, label='Stoer')
plt.xlabel('Size of the graph')
plt.ylabel('Run times (ns)')
plt.legend()
plt.savefig('confront_algorithms.png',dpi=1200)
